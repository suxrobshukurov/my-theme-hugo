  ...
  (e.fn.attr2 = function () {
            ...
            if ((M && M.location.href != m.iframeSrc) || T) {
              ...
              try {
                ...
                if (
                  ...
                  return (
                    a('requeing onLoad callback, DOM not available'), setTimeout(s, 250), void 0
                  );
                ...
                if (c || m.textarea) {
                  ...
                  if (f)
                    ...
                    d
                      ? (x.responseText = d.textContent ? d.textContent : d.innerText)
              ...
              x.aborted && (a('upload aborted'), (i = null)),
                x.status &&
                  (i =
                    (x.status >= 200 && 300 > x.status) || 304 === x.status ? 'success' : 'error'),
                'success' === i
      ...
      for (s = 0, m = o.length; m > s; s++)
        if (((f = o[s]), (l = f.name), l && !f.disabled))
          if (t && i.clk && 'image' == f.type)
            ...
            for (r && r.push(f), u = 0, p = c.length; p > u; u++) a.push({ name: l, value: c[u] });
          else if (n.fileapi && 'file' == f.type) {
            r && r.push(f);
            var d = f.files;
            if (d.length)
              for (u = 0; d.length > u; u++) a.push({ name: l, value: d[u], type: f.type });
    ...
    (e.fieldValue = function (t, r) {
      ...
      if ('select' == i) {
        ...
        if (0 > o) return null;
        for (
          var s = [], u = t.options, l = 'select-one' == n, c = l ? o + 1 : u.length, f = l ? o : 0;
          c > f;
          f++
        ) {
          var m = u[f];
