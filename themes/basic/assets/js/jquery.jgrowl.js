!(function (a) {
  (a.jGrowl = function (b, c) {
    ...
    (a.fn.jGrowl = function (b, c) {
      if (
        (void 0 === c && a.isPlainObject(b) && ((c = b), (b = c.message)), a.isFunction(this.each))
      ) {
        var d = arguments;
        return this.each(function () {
          void 0 === a(this).data('jGrowl.instance') &&
            (a(this).data(
              'jGrowl.instance',
              a.extend(new a.fn.jGrowl(), { notifications: [], element: null, interval: null }),
            ),
            a(this).data('jGrowl.instance').startup(this)),
            a.isFunction(a(this).data('jGrowl.instance')[b])
              ? a(this)
                  .data('jGrowl.instance')
                  [b].apply(a(this).data('jGrowl.instance'), a.makeArray(d).slice(1))
            ...
            a(this).data('jGrowl.pause', !0),
              a(this).animate(e.animateClose, e.closeDuration, e.easing, function () {
                a.isFunction(e.close)
                  ? e.close.apply(f, [f, d, e, c.element]) !== !1 && a(this).remove()
                  : a(this).remove();
              });
          })
              ...
              .bind('click.jGrowl', function () {
                a(this).siblings().trigger('jGrowl.beforeClose'),
                  a.isFunction(c.defaults.closer) &&
                    c.defaults.closer.apply(a(this).parent()[0], [a(this).parent()[0]]);
              });
      },
      update: function () {
        a(this.element)
          ...
          .each(function () {
            void 0 !== a(this).data('jGrowl') &&
              ...
              a(this).data('jGrowl').created.getTime() + parseInt(a(this).data('jGrowl').life, 10) <
                new Date().getTime() &&
          ...
          this.notifications.length > 0 &&
            (0 === this.defaults.pool ||
              a(this.element).find('.jGrowl-notification:parent').length < this.defaults.pool) &&
